...
When a new node is inserted into the Treap, it is first added according to BST rules (based on string comparison). After insertion, the heap property is checked, and rotations are applied if the heap property is violated.
